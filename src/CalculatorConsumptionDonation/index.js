  ...
  return (
    <div className={styles.outerWrapper} >
      ...
      <Wrapper
        ...
        >
        <CounterInputGeneral
          decreaseValue={props.donationDecreased}
          increaseValue={props.donationIncreased}
          value={props.donation}
          valueType={'NOK (kroner)'}
          />
      </Wrapper>
    </div>
  );
...
CalculatorConsumptionDonation.propTypes = {
  ...
  donationDecreased: PropTypes.func,
  donationIncreased: PropTypes.func
